            ...
            <div class="card-group">
                <div class="card mb-4 d-flex">
                    <div class="card-header bg-primary">
                        <h5 class="card-title text-white"> <i class="fas fa-user-circle"></i><b> Edit Data Siswa</b></h5>
                    </div>

                    <div class="card-body">
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-four-bio-diri-tab" data-toggle="pill" href="#custom-tabs-bio-diri" role="tab"><i class="fas fa-user-friends"></i> Data Siswa</a>
                            </li>
                        </ul>
                        <p></p>

                        <form action="<?php base_url("data/editsiswa") ?>" method="post">
                                ...
                                <div class="tab-pane fade active show" id="custom-tabs-bio-diri" role="tabpanel">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="date" data-date-format="mm/dd/yyyy" id="tanggal_lahir" name="tanggal_lahir" value="<?= $siswa->tanggal_lahir ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">No Handphone</label>
                                            <input type="text" class="form-control" id="no_hp" name="no_hp" onkeypress="return event.charCode >= 48 && event.charCode <=57" maxlength="14" value="<?= $siswa->no_hp ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="motto" name="motto" value="<?= $siswa->motto ?>">
                                        </div>
