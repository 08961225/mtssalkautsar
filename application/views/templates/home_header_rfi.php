...
<body>
    ...
    <nav class="main-nav-outer" id="test">
        ...
        <div class="container">
            <ul class="main-nav">
                <li><a href="<?= base_url('home/#header') ?>">Home</a></li>
                <li><a href="<?= base_url('home/#service') ?>">Division</a></li>
                <li><a href="<?= base_url('home/#Portfolio') ?>">Product</a></li>
                <li class="small-logo"><a href="#header"><img src="<?= base_url('assets/'); ?>vendor/home/img/small-logo.png" alt=""></a></li>
                <li><a href="<?= base_url('home/#client') ?>">Team</a></li>
