            ...
            <div class="card-group">
                <div class="card mb-4 d-flex">
                    <div class="card-header bg-primary">
                        <h5 class="card-title text-white"> <i class="fas fa-list-ol"></i><b> Hisotry Nilai Siswa</b></h5>
                    </div>
                                    ...
                                    <div class="tab-pane fade active show" id="custom-tabs-bio-diri" role="tabpanel">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="username_guru" name="username_guru" value="<?= $user['name'] ?>" disabled>
                                            </div>

                                            <input type="hidden" id="username_guru" name="username_guru" value="<?= $user['email'] ?>">
